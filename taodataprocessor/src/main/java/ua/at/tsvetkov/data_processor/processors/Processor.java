...
//               sendMessage(ERROR, null);
         ...
         Log.e("Timeout error creating the "+ clazz +" in request " + request.toString(), e);
         sendMessage(ERROR, null);
      }  catch (IOException e) {
         Log.e("IOException for "+ clazz +" in request " + request.toString(), e);
         sendMessage(ERROR, null);
      }finally {
         try {
            if (inputStream != null) {
   ...
   public static interface Callback<T> {
       ...
       *           For http request - HTTP Status Code see {@link HttpStatus} constant.<br>
